...
.PHONY: run-local
run-local:
	ENV=LOCAL LOCAL_DATABASE_POSTGRES_URI=postgres://postgres:password@localhost:5433/hongjot?sslmode=disable SERVER_PORT=8080 LOCAL_ENABLE_CREATE_SPENDER=false go run main.go
